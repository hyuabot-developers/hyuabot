<template>
  <q-card class="full-width">
    <q-card-section class="bg-primary text-white">
      <div class="text-h6">{{ $t(`shuttle.${shuttle.stopCode}`) }}</div>
    </q-card-section>
    <q-card-section
      style="padding-top: 0; padding-bottom: 0"
      @click="isExpandedFirst = !isExpandedFirst">
      <div class="row">
        <div class="text-subtitle1 col-4 items-center">
          {{ $t(`shuttle.heading.${shuttleHeadingList[shuttle.stopCode][0]}`) }}
        </div>
        <div class="col-8">
          <q-list dense>
            <q-item
              ...
              style="padding: 0"
            >
              <div class="col-6 items-center" :style="{color: shuttleDepartureItem.type === 'C' ? 'var(--q-secondary)' : '#FF0000'}">
    ...
    <q-card-section
      ...
      style="padding-top: 0; padding-bottom: 0"
      @click="isExpandedSecond = !isExpandedSecond">
      <div class="row">
        <div class="text-subtitle1 col-4 items-center">{{ $t(`shuttle.heading.${shuttleHeadingList[shuttle.stopCode][1]}`) }}</div>
        <div class="col-8">
          <q-list dense>
            <q-item
