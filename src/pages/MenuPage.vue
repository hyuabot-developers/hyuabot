    ...
    <q-list bordered separator style="width: 100%; height: 240px; margin: 10px">
      <q-item clickable>
        <q-item-section avatar v-ripple>
          <q-icon color="secondary" name="mdi-library" />
        </q-item-section>
        <q-item-section>열람실 좌석 정보</q-item-section>
      </q-item>
      <q-item clickable>
        <q-item-section avatar v-ripple>
          <q-icon color="secondary" name="mdi-calendar" />
        </q-item-section>
        <q-item-section>학사력</q-item-section>
      </q-item>
      <q-item clickable>
        <q-item-section avatar v-ripple>
          <q-icon color="secondary" name="mdi-map" />
        </q-item-section>
        <q-item-section>캠퍼스 지도</q-item-section>
      </q-item>
      <q-item clickable>
        <q-item-section avatar v-ripple>
          <q-icon color="secondary" name="mdi-account-box" />
        </q-item-section>
